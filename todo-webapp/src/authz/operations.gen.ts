...
export const OPERATIONS: Record<OperationKey, OperationRequirement> = {
  "DELETE /todos/{todoId}": { kind: "scope", scope: "todos:manage" },
  "GET /todos": { kind: "scope", scope: "todos:read" },
  "PATCH /todos/{todoId}": { kind: "scope", scope: "todos:manage" },
  "POST /todos": { kind: "scope", scope: "todos:manage" },
};
